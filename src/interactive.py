"""Self-contained click-to-similarity HTML visualizer for latent maps."""
...
def build_html(
    ...
    *,
    ...
    similarity_source_text = html_lib.escape(str(similarity_input_path))
...
// Decode raw RGBA to a canvas — no PNG/PIL needed.
