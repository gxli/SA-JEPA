#!/usr/bin/env python3
"""Generate gen_100 focused readability / predictor-snake sweep configs."""
...
DATASETS = [
    ("mhd", "C12_Beta20_256_0060-rho.npy_slice.npy_sm_0.5.npy"),
    ("chengdu", "chengdu.npy"),
...
def main() -> None:
    ...
    for stale_path in glob(os.path.join(OUT_DIR, "gen_100_*.json")):
